...
function renderMainTable() {
  ...
  categories.forEach((cat) => {
    ...
    tr.innerHTML = `
      ...
      <td><input class="editable-input" type="number" autocomplete="new-password" value="${cat.earned_credits ?? ''}" data-type="category" data-id="${cat.id}" data-field="earned_credits"></td>
...
function renderDetailsTable(categoryId) {
  ...
  catBaskets.forEach(basket => {
    html += `<tr>
      ...
      <td><input class="editable-input" type="number" autocomplete="new-password" value="${basket.earned_credits ?? ''}" data-type="basket" data-id="${basket.id}" data-field="earned_credits"></td>
